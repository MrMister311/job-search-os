...
people in the contacts ledger, and every number: all fictional, written to show what a
populated system looks like after intake and one application. No real person or organization
is depicted, and any resemblance to an actual company, product, or person, living or dead, is
coincidental. Email addresses use the reserved `example.com` domain and phone numbers use the
reserved 555 prefix.
...
6. `applications/ironwood-robotics-.../`: the 15-minute tailor. `tailoring_notes.md` starts with
